...
console.log(Object.keys(users).length) //to get number of keys in object

//console.log(Object.values(users)) //to get all keys of object
...
Object.keys(users).length>0 ? console.log('not empty') : console.log('empty');
